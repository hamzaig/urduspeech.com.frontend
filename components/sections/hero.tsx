        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-playfair leading-tight mb-6">
              Professional <span className="text-blue-600">Urdu</span> Language
              Services
            </h1>
            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-6">
                  Our advanced technology converts your Urdu speech into
                  accurate text. Perfect for transcriptions, documentation, and
                  more.
                </p>
